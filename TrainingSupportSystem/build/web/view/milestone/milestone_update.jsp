                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Update Milestone</h5>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="rounded shadow mt-4">
                                                    <div class="p-4 border-bottom">
                                                        <h6 class="mb-0">Assignment detail: ${assbody}</h6>
                                                    </div>

                                                    <div class="p-4">
                                                        <form id="form1" action="milestone?action=edit" method="Post">

                                                            <input type="hidden" name="id" value="${milestone.milestone_id}"/>
                                                            <input type="hidden" name="ass_body" value="${assbody}"/>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input 
                                                                            ...
                                                                            required="" name="tittle" id="name2" type="text" class="form-control" placeholder="Tittle:" value="${milestone.tittle}" maxlength="21"  onkeydown="limit(this);" onkeyup="limit(this);" >
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Class:</label>
                                                                         ...
                                                                         <input 
                                                                             ...
                                                                             required="" name="tittle" id="name2" type="text" class="form-control" placeholder="Tittle:" value="${cname}" readonly="">
                                                                    </div>
                                                                </div><!--end col-->
                                                        ...
                                                        <button onclick="f3()" style="float: right" type="submit" class="btn btn-primary">Update</button>                       
