                ...
                <div class="container-fluid">
                    <div class="layout-specing">
                        <div class="d-md-flex justify-content-between">
                            <h5 class="mb-0">Update Eval information</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mt-4">
                                <div class="card border-0 p-4 rounded shadow">
                                    ...
                                    <form  action="eval_detail" method="post" class="mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        required="" maxlength="30" name="eval_name" id="name2" type="text" class="form-control" placeholder="title :" value="${eval_name}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="ass_body" readonly="" required="" id="name" type="text" class="form-control" value="${assignment}" placeholder="Assignment Name :">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input 
                                                        name="eval_weight"  type="number" min="0" max="100" class="form-control" placeholder="evalweight :" value="${eval_weight}"/>
                                                </div>
                                            </div><!--end col-->
                                             <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input 
                                                        name="max_loc"  type="number" class="form-control" placeholder="max_loc :" value="${max_loc}"/>
                                                </div>
                                            </div><!--end col-->
                                             <div class="col-md-6">
                                                <div class="mb-3">
