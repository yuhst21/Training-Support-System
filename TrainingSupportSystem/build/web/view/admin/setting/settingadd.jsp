                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mt-4">
                                <div class="card border-0 p-4 rounded shadow">
                                    ...
                                    <form id="frm" action="settinglist" method="post" class="mt-4">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="settingtype" class="form-select">
                                                        <c:forEach items="${requestScope.setting_type}" var="s">
                                                            <option <c:if test="${s.setting_id == sessionScope.setlist.setting_id}">selected=""</c:if>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        required="" name="settingtitle" id="name2" type="text" class="form-control" value="${sessionScope.setlist.setting_tiltle}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        required="" name="settingvalue" id="name2" type="text" class="form-control" value="${sessionScope.setlist.setting_value}">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        name="settingorder" id="name2" type="text" class="form-control" value="${sessionScope.setlist.display_order}">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-12">
                                                    ...
                                                    <textarea id="textid" name="description" rows="5"  style="width: 400px" 
                                                              ...
                                                              maxlength="201" >${setlist.description}</textarea>
                                                </div>
                                    ...
                                    <button onclick="modal_open2()" style="width: 100px ;margin-left:  70%" type="submit" class="button-10">Add</button>
                                </div>
                            </div><!--end col-->
