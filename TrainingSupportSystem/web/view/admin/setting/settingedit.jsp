...
<html lang="en">
    ...
    <head>
        ...
        <script src="assets/js/confirm_setting_update.js" type="text/javascript"></script>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="settingtype" class="form-select">
                                                        <c:forEach items="${requestScope.setting_type}" var="s">
                                                            <option <c:if test="${s.setting_id == classset.type_id}">selected=""</c:if>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        required="" name="settingtitle" id="name2" type="text" class="form-control" value="${classset.setting_tiltle}">
                                                    <p style="color:red;"></p>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input
                                                        name="settingvalue" id="name2" type="text" class="form-control" value="${classset.setting_value}">
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
