<%-- 
    ...
    Created on : Sep 24, 2022, 1:59:49 PM
    Author     : win
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu nav-left nav-light">
                        ...
                        <li><a href="" class="sub-menu-item" target="_blank">Admin</a></li>
        ...
        <!-- Start Hero -->
        <section class="bg-half-170 d-table w-100" style="background: url('assets/images/about/imghome1.jpg');">
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center">
                            ...
                            <p class="para-desc mx-auto text-white-50">Training Support System.</p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <div class="custom-form rounded shadow p-4">
                            ...
                            <form action="contact" method="post" name="myForm" onsubmit="return validateForm()">
                                <p id="error-msg"></p>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input maxlength="50" name="name" id="name" type="text" class="form-control border rounded" placeholder="First Name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input required="" name="email" id="email" type="email" class="form-control border rounded" placeholder="Your email">
                                        </div> 
                                    </div><!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Your Phone <span class="text-danger">*</span></label>
                                            <input name="mobile" id="phone" type="text" class="form-control border rounded" placeholder="Your phone">
                                        </div> 
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea maxlength="200" name="message" id="message" required="" rows="4" class="form-control border rounded" placeholder="Your message"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
