...
<html lang="en">
    ...
    <head>
        ...
        <script src="assets/js/confirm_class.js" type="text/javascript"></script>
        <script src="assets/js/pagger_byclass.js" type="text/javascript"></script>
                            ...
                            <form action="classlist" method="get" >
                                ...
                                <div class="row">  
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            ...
                                            <select name="class_get" class="select-1">
                                                <c:forEach items="${sessionScope.setting_per}" var="s">
                                                    <option <c:if test="${s.class_id == cla}">selected=""</c:if>
                                    ...
                                    <div class="col-md-2" style="margin-right: 60px">
                                        <div class="mb-3">
                                            <br/>
                                            <select name="support_get" class="select-1">
                                                <option value="-1">All Supporter</option>
                                                <c:forEach items="${sessionScope.supporter}" var="s">
                                                    <option <c:if test="${s.user_id == sup}">selected=""</c:if>
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            <br/>
                                            <select name="trainer_get" class="select-1">
                                                <option value="-1">All Trainer</option>
                                                <c:forEach items="${sessionScope.trainer}" var="s">
                                                    <option <c:if test="${s.user_id == train}">selected=""</c:if>
                                                                                               value="${s.user_id}">${s.full_name}</option>
                                                </c:forEach>  
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <button class="button-10" onclick="location.href = 'classlist?action=add'" type="button">Add</button>    
                                            </div>
                                        </div><!--end col-->
                                    </div>
                                </form>
                                            ...
                                            <div class="col-12 mt-4">
                                                <div class="table-responsive bg-white shadow rounded">
                                                    <table class="table table-center mb-0 table-sortable">
                                                        <thead>
                                                            <tr>
                                                                <th class="border-bottom p-3">Class Id</th>
                                                                <th class="border-bottom p-3">Class Name</th>
                                                                <th class="border-bottom p-3">Supporter Name</th>
                                                                <th class="border-bottom p-3" >Trainer Name</th>
                                                                <th class="border-bottom p-3">Term</th>
                                                        ...
                                                        <c:forEach items="${requestScope.setting_fil}" var="w">
                                                            <tr>
                                                                ...
                                                                <td class="p-3">${w.class_name}</td>
                                                                <td class="p-3">${w.supporter_name}</td>
                                                                <td class="p-3">${w.trainee_name}</td>
                                                                <td class="p-3">${w.term_name}</td>
                                                                <td class="p-3">${w.subject.subject_code}</td>
                                                                <td class="p-3">
                                                                ...
                                                                <td class="p-3">
                                                                    <form id="status_form_${w.class_id}" action="classlist">
                                                                        <input type="hidden" name="action" value="view">
                                                                        <input name="page" type="hidden" value="${page_index}">

                                                                        <input type="hidden" name="change_status" value="${w.class_id}_${w.status}"/>
                                                                        <c:if test="${w.status eq true}">

                                                                            <label  class="switch-wrap"  style="float: left">
                                                                                <input type="checkbox" id="status_check_${w.class_id}" checked onChange="modal_open(${w.class_id})"/>
                                                                        ...
                                                                        <c:if test="${w.status eq false}">
                                                                            ...
                                                                            <label  class="switch-wrap"  style="float: left">
                                                                                <input type="checkbox" id="status_check_${w.class_id}" onChange="modal_open(${w.class_id})"/>
                                                                                <div class="switch"></div>
                                                                            </label>
                                                                    ...
                                                                    <label style="float: right;">
                                                                        <a href="classlist?action=edit&class_id=${w.class_id}" class="btn btn-icon btn-pills btn-soft-primary" ><i class="uil uil-pen"></i></a>
                                                                    </label>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="d-md-flex align-items-center text-center justify-content-between">
                                                ...
                                                <ul id="only-pagger" class="pagination justify-content-center mb-0 mt-3 mt-sm-0">
                                                    <script>
                                                        render("only-pagger",${page_index},${total_page}, 2,${sup},${train},${cla},${status},${sessionScope.managerr});
                                                    </script>
                                                </ul>
                                            </div>
                                        </div><!--end col-->
