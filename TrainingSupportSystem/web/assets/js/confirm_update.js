...
function modal_open2() {
    ...
    if (to_time === "") {
        ...
        var content = document.getElementById('check');
        content.innerHTML = "<p id=\"cac\" style=\"color: red\">To time can't be equals or smaller than from time</p>";
    ...
    if (!training_date) {
     ...
     if (from_time <= to_time && training_date>=today && to_time !== null && from_time !== null && training_date ) {
        var html = document.getElementById("model_content");
