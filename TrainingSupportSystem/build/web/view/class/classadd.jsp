                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="class_name" required="" id="name" type="text" class="form-control" value="${sessionScope.data.class_name}" >
                                                </div>
                                            </div><!--end col-->
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="sub_code" class="form-select">
                                                        <c:forEach items="${sessionScope.list_sub}" var="s">
                                                            <option <c:if test="${s.subject_id == sessionScope.data.subject.subject_id}">selected=""</c:if>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="support_get" class="form-select">
                                                        <c:forEach items="${sessionScope.supporter}" var="s">
                                                            <option <c:if test="${s.user_id == sessionScope.data.supporter_id}">selected=""</c:if>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="trainer_get" class="form-select">
                                                        <c:forEach items="${sessionScope.trainer}" var="s">
                                                            <option <c:if test="${s.user_id == sessionScope.data.trainer_id}">selected=""</c:if>
                                                                value="${s.user_id}">${s.full_name}</option>
                                                        </c:forEach> 
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="term_get" class="form-select">
                                                        <c:forEach items="${requestScope.term_type1}" var="s">
                                                            <option  <c:if test="${s.term_id == sessionScope.data.term_id}">selected=""</c:if>
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-12">
                                                    ...
                                                    <textarea id="textid" name="description" rows="5"  style="width: 400px" 
                                                              ...
                                                              maxlength="201" >${sessionScope.data.description}</textarea>
                                                </div>
