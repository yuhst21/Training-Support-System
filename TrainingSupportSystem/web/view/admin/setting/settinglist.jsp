...
<html lang="en">
    ...
    <head>
        ...
        <script src="assets/js/paggerv2.js" type="text/javascript"></script>
    ...
    <body>
        <div id="demo-modal" class="modal">
            <div class="modal__content" id="model_content">
                ...
                <p>
                    Do you want to change setting status ? 
                </p>
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            ...
                                            <select name="type" class="select-1">
                                                ...
                                                <c:forEach items="${requestScope.setting_type}" var="s">
                                                    <option <c:if test="${settingtype == s.setting_id}">selected=""</c:if>
                                                                                                        value="${s.setting_id}">${s.setting_tiltle  }</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-2" style="margin-left: 50px">
                                        <div class="mb-3">
                                            ...
                                            <select name="status" class="select-1">
                                                ...
                                                <option <c:if test="${settingstatus eq 1}">selected=""</c:if>  
                                                                                           value="1">Active</option>
                                                    <option <c:if test="${settingstatus eq 0}">selected=""</c:if>  
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                <br/>
                                                <input style="width: 100%" type="text" name="settingtitle" class="form-control" value="${settingtitle}" placeholder="Enter Setting Title">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            ...
                                            <button class="button-10" onclick="location.href = 'settinglist?action=add'" type="button">Add</button>    
                                        </div>
                                    </div><!--end col-->
                                </div>
                            </form>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="table-responsive bg-white shadow rounded">
                                                <table class="table table-center mb-0 table-sortable">
                                                    <thead>
                                                        <tr>
                                                            <th class="border-bottom p-3" ><b>Id</b></th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${requestScope.setting_fil}" var="w">
                                                            <tr>
                                                                ...
                                                                <td class="p-3">${w.type_name}</td>
                                                                <td class="p-3">${w.setting_tiltle}</td>
                                                                ...
                                                                <td class="p-3">
                                                                    ...
                                                                    <label style="float: right;">
                                                                        <a href="settinglist?action=edit&setting_id=${w.setting_id}" class="btn btn-icon btn-pills btn-soft-primary" ><i class="uil uil-eye"></i></a>
                                                                    </label>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                        ...
                                        <div class="col-12 mt-4">
                                            <div class="d-md-flex align-items-center text-center justify-content-between">
                                                ...
                                                <ul id="only-pagger" class="pagination justify-content-center mb-0 mt-3 mt-sm-0">
                                                    <script>
                                                        render("only-pagger",${page_index},${total_page}, 2,${settingtype},${settingstatus}, "${settingtitle}");
                                                    </script>
                                                </ul>
                                            </div>
                                        </div><!--end col-->
