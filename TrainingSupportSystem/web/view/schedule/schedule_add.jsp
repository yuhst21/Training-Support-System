        ...
        <script>
            ...
            function change() {
                ...
                if (from_time > to_time) {
                    ...
                    content.innerHTML = "<p id=\"check2\" style=\"color: red\">To time can't be smaller than  from time</p>";
                }
                if (from_time < to_time) {
                    var content2 = document.getElementById('check');
                    var content1 = document.getElementById('check2');
                    content2.removeChild(content1);
                }
            }
            ...
            function checkdate() {
                ...
                if (training_date < today) {
                    ...
                    content.innerHTML = "<p id=\"checkdate2\" style=\"color: red\">To time can't be smaller than  from time</p>";

                }
                if (training_date > today) {
                    var content = document.getElementById('checkdate2');
                    content.innerHTML = "";
...
function loz() {
    ...
    } else if(training_date < today && training_date){
        var content = document.getElementById('checkdate');
        content.innerHTML = "<p id=\"cac\" style=\"color: red\">Date can't be smaller than today</p>";
    } 
    else {
    ...
    if(topic.length === min_chars){
     ...
     if (from_time < to_time && to_time !== null && from_time !== null && training_date && topic.length>min_chars && training_date>=today ) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="rounded shadow mt-4">
                                                    ...
                                                    <div class="p-4">
                                                        <form id="dcmm" action="schedule?action=add" method="Post">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select onchange="f1()" id="slot_id"  style="text-align: center" class="form-control"   style="margin-right: 80px;" class="s_filter" name="class_id" > 
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input id="from_time"  style="text-align: center" type="time" class="form-control" placeholder="New password" required=""  name="from_time" >
                                                                    </div>
                                                                    <div id="txt1"></div>
                                                                </div><!--end col-->
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input id="to_time" style="text-align: center" type="time" class="form-control" placeholder="New password" required="" name="to_time"  >
                                                                    </div>
                                                                    <div id="check"></div>
                                                                </div><!--end col-->
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <span class="badge bg-soft-muted">Not yet</span>
                                                        ...
                                                        <input style="float:right"  class="btn btn-primary"  type="submit" value="Add" onclick="loz()"/>
                                                        </br>
                                                        </br>
